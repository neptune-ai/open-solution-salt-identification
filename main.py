...
def train_evaluate_predict_cv(pipeline_name, submit_predictions, dev_mode):
    pipeline_manager.train_evaluate_predict_cv(pipeline_name, submit_predictions, dev_mode)
...
def evaluate_cv(pipeline_name, dev_mode):
    pipeline_manager.evaluate_cv(pipeline_name, dev_mode)
...
def evaluate_predict_cv(pipeline_name, submit_predictions, dev_mode):
    pipeline_manager.evaluate_predict_cv(pipeline_name, submit_predictions, dev_mode)
